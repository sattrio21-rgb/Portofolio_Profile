        ...
        <div class="max-w-6xl mx-auto px-6 sm:px-8">
            <div class="max-w-2xl">
                ...
                <div class="flex items-center gap-4 mb-4">
                    ...
                    <div>
                        <h1 class="text-4xl sm:text-5xl font-bold text-white">{{ $profile->judul_bem ?? 'BEM' }}</h1>
                        <p class="text-lg text-gray-400">{{ $profile->deskripsi_bem ?? 'Badan Eksekutif Mahasiswa' }}</p>
                    </div>
                </div>
            </div>
        </div>
