    ...
    <div class="min-h-screen flex">
        ...
        <aside id="sidebar" class="hidden lg:flex lg:flex-col w-72 bg-white border-r border-gray-200 fixed inset-y-0 z-40">
            ...
            <nav class="flex-1 px-4 py-6 space-y-1">
                ...
                <a href="{{ route('admin.edit-pendidikan') }}"
                   class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 {{ request()->routeIs('admin.edit-pendidikan') ? 'bg-blue-50 text-blue-600' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
